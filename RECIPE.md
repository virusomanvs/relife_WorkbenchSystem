...
| `chance` | float | Шанс получения результата. Если у всех chance будет 0, то все. Если у хоть у одно больше 0, то будет выбран 1 согласно его весу, чем больше тем больше шанс, седди остальных  |
